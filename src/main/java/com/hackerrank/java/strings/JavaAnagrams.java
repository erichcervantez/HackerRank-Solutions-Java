 ...
 * but may be in different orders. So the list of anagrams of CAT are "CAT",
 * "ACT" , "TAC", "TCA" ,"ATC" and "CTA.
 * <p>
 * Given two strings, print "Anagrams" if they are anagrams, print "Not Anagrams"
 * if they are not. The strings may consist at most 50 english characters, the
 * comparision should NOT be case sensitive.
 * <p>
 * This exercise will verify that you are able to sort the characters of a string,
